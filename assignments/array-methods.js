...
// Problem 1: Use .filter() to see if first_name starts with 'M'
let lastName = [];

console.log(runners.filter(runner => runner.last_name.startsWith('S')));

// Problem 2: Some companies donated too little money and were convinced to double their contribution if they initially gave less than $250.00. We want to see how much that number equals now.
console.log(
  runners
